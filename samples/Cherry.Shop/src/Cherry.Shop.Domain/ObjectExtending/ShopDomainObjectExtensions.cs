...
namespace Cherry.Shop.ObjectExtending
{
    public static class ShopDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the ShopEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
